...
// Puedes generar la aleatoriedad con Math.floor(Math.random() * 5) + 1, este método devuelve un entero del 1 al 5,
...
function setInstructions() {
    moves = prompt('Introduzca coordenadas');
}
            ...
            switch (moves[i]) {
                ...
                case 'W':
                 if(moveWest()){
                    ...
                    break;
                default:
                console.log('Coordenada no valida')
                return 
            }
